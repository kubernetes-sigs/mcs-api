...
import (
	...
	apisv1alpha2 "sigs.k8s.io/mcs-api/pkg/apis/v1alpha2"
	...
	v1alpha2 "sigs.k8s.io/mcs-api/pkg/client/listers/apis/v1alpha2"
)
...
type ServiceImportInformer interface {
	...
	Lister() v1alpha2.ServiceImportLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MulticlusterV1alpha2().ServiceImports(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MulticlusterV1alpha2().ServiceImports(namespace).Watch(context.TODO(), options)
			},
		},
		&apisv1alpha2.ServiceImport{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceImportInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisv1alpha2.ServiceImport{}, f.defaultInformer)
}

func (f *serviceImportInformer) Lister() v1alpha2.ServiceImportLister {
	return v1alpha2.NewServiceImportLister(f.Informer().GetIndexer())
}
