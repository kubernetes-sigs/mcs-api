...
type ServiceExportInformer interface {
	...
	Lister() v1alpha2.ServiceExportLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MulticlusterV1alpha2().ServiceExports(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MulticlusterV1alpha2().ServiceExports(namespace).Watch(context.TODO(), options)
			},
		},
		&apisv1alpha2.ServiceExport{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *serviceExportInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&apisv1alpha2.ServiceExport{}, f.defaultInformer)
}

func (f *serviceExportInformer) Lister() v1alpha2.ServiceExportLister {
	return v1alpha2.NewServiceExportLister(f.Informer().GetIndexer())
}
