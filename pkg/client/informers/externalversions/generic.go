...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("serviceimports"):
		...
		// Group=multicluster.x-k8s.io, Version=v1alpha2
	case v1alpha2.SchemeGroupVersion.WithResource("serviceexports"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Multicluster().V1alpha2().ServiceExports().Informer()}, nil
	case v1alpha2.SchemeGroupVersion.WithResource("serviceimports"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Multicluster().V1alpha2().ServiceImports().Informer()}, nil
