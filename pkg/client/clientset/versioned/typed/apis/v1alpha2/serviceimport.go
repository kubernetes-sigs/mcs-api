...
type ServiceImportInterface interface {
	Create(ctx context.Context, serviceImport *v1alpha2.ServiceImport, opts v1.CreateOptions) (*v1alpha2.ServiceImport, error)
	Update(ctx context.Context, serviceImport *v1alpha2.ServiceImport, opts v1.UpdateOptions) (*v1alpha2.ServiceImport, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.ServiceImport, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.ServiceImportList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.ServiceImport, err error)
...
func newServiceImports(c *MulticlusterV1alpha2Client, namespace string) *serviceImports {
...
func (c *serviceImports) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.ServiceImport, err error) {
	result = &v1alpha2.ServiceImport{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *serviceImports) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.ServiceImportList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.ServiceImportList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("serviceimports").
...
func (c *serviceImports) Create(ctx context.Context, serviceImport *v1alpha2.ServiceImport, opts v1.CreateOptions) (result *v1alpha2.ServiceImport, err error) {
	result = &v1alpha2.ServiceImport{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("serviceimports").
...
func (c *serviceImports) Update(ctx context.Context, serviceImport *v1alpha2.ServiceImport, opts v1.UpdateOptions) (result *v1alpha2.ServiceImport, err error) {
	result = &v1alpha2.ServiceImport{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("serviceimports").
...
func (c *serviceImports) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.ServiceImport, err error) {
	result = &v1alpha2.ServiceImport{}
