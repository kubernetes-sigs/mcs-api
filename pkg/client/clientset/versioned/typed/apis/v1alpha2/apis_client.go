...
// MulticlusterV1alpha2Client is used to interact with features provided by the multicluster.x-k8s.io group.
type MulticlusterV1alpha2Client struct {
	restClient rest.Interface
}

func (c *MulticlusterV1alpha2Client) ServiceExports(namespace string) ServiceExportInterface {
	return newServiceExports(c, namespace)
}

func (c *MulticlusterV1alpha2Client) ServiceImports(namespace string) ServiceImportInterface {
...
// NewForConfigAndClient creates a new MulticlusterV1alpha2Client for the given config and http client.
...
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*MulticlusterV1alpha2Client, error) {
	...
	return &MulticlusterV1alpha2Client{client}, nil
}

// NewForConfigOrDie creates a new MulticlusterV1alpha2Client for the given config and
...
func New(c rest.Interface) *MulticlusterV1alpha2Client {
	return &MulticlusterV1alpha2Client{c}
}
